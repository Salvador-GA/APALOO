/**
 * Clase Principal, utiliza los metodos de una lista circular para
...
public class Principal {
        ...
        ListaCircular l1 = new ListaCircular(5);
        ...
        System.out.println("Estado interno de la lista: \n"+l1.estadoActual());
        System.out.println("----------------------------------------");
        ...
        System.out.println("---------- Insertar al final b ---------");
        ...
        System.out.println("------ Insertar en la posicion 1 h -----");
        if(l1.insertar("h",1)){
            System.out.println("Insercion correcta");
        } else {
            System.out.println("No se pudo insertar");
        ...
        System.out.println("---------- Insertar al final i ---------");
        if(l1.insertarFinal("i")){
            System.out.println("Insercion correcta");
        } else {
            System.out.println("No se pudo insertar");
        }
        ...
        System.out.println("---------- Insertar al final j ---------");
        if(l1.insertarFinal("j")){
            System.out.println("Insercion correcta");
        } else {
            System.out.println("No se pudo insertar");
        }
        ...
        System.out.println("---------- Insertar al final k ---------");
        if(l1.insertarFinal("k")){
            System.out.println("Insercion correcta");
        } else {
            System.out.println("No se pudo insertar");
        }
        ...
        System.out.println("------ Insertar en la posicion 3 l -----");
        if(l1.insertar("l",3)){
            System.out.println("Insercion correcta");
        } else {
            System.out.println("No se pudo insertar");
